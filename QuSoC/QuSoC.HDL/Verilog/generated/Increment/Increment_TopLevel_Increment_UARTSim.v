...
// 
// System configuration name is Increment_TopLevel_Increment_UARTSim, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module Increment_TopLevel_Increment_UARTSim (
// [BEGIN USER PORTS]
// [END USER PORTS]
...
initial
begin
	$readmemh("Increment_TopLevel_Increment_UARTSim_State_UART.hex", State_UART);
end
