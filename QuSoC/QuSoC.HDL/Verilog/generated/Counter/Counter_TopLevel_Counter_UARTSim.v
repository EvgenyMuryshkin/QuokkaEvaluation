...
// 
// System configuration name is Counter_TopLevel_Counter_UARTSim, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module Counter_TopLevel_Counter_UARTSim (
// [BEGIN USER PORTS]
// [END USER PORTS]
...
initial
begin
	$readmemh("Counter_TopLevel_Counter_UARTSim_State_UART.hex", State_UART);
end
