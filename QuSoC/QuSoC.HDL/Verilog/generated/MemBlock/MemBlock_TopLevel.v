...
wire  [1:0] QuSoCModule_L108F13L121T14_CombinedModuleIsActive_Size = 2'b11;
wire  QuSoCModule_L79F31T33_Expr = 1'b0;
wire  RISCVModule_Types_L11F30T35_Expr = 1'b0;
wire  QuSoCModule_L87F33T43_Expr = 1'b0;
wire  [31:0] MemBlock_generated_L17F104T114_Expr = 32'b10000000000000000000000000000000;
wire  [31:0] MemBlock_generated_L18F105T115_Expr = 32'b10000000000100000000000000000000;
...
wire  [2:0] CombinedModuleIsActive;
...
wire  MemBlockModule_Common_RE;
wire  [1:0] MemBlockModule_Common_MemAccessMode;
wire  [31:0] MemBlockModule_DeviceAddress;
wire  [31:0] MemBlockModule_ReadValue;
wire  MemBlockModule_IsReady;
wire  MemBlockModule_IsActive;
wire  [2:0] QuSoCModule_L46F47T98_Source;
...
wire  MemBlockModuleCommon_REMemBlockModule_Common_REHardLink;
wire  [1:0] MemBlockModuleCommon_MemAccessModeMemBlockModule_Common_MemAccessModeHardLink;
wire  [31:0] MemBlockModuleDeviceAddressMemBlockModule_DeviceAddressHardLink;
wire  [31:0] MemBlockModuleReadValueMemBlockModule_ReadValueHardLink;
wire  MemBlockModuleIsReadyMemBlockModule_IsReadyHardLink;
wire  MemBlockModuleIsActiveMemBlockModule_IsActiveHardLink;
reg  State_MemReady = 1'b0;
wire  State_MemReadyDefault = 1'b0;
wire  [2:0] QuSoCModule_L46F47T109_Expr;
wire  [2:0] QuSoCModule_L46F47T109_Expr_1;
...
State_MemReady <= NextState_MemReady;
    ...
    generate
    for (LogicalFunctionLogicalFunction1_idx = 2; LogicalFunctionLogicalFunction1_idx >= 0; LogicalFunctionLogicalFunction1_idx = LogicalFunctionLogicalFunction1_idx - 1)
    begin : LogicalFunctionLogicalFunction1_idxReverse
assign QuSoCModule_L46F47T109_Expr[LogicalFunctionLogicalFunction1_idx] = QuSoCModule_L46F47T109_Expr_1[2 - LogicalFunctionLogicalFunction1_idx];
end
    endgenerate

MemBlock_TopLevel_MemBlock_CPU MemBlock_TopLevel_MemBlock_CPU
(
...
MemBlock_TopLevel_MemBlock_InstructionsRAM MemBlock_TopLevel_MemBlock_InstructionsRAM
(
...
MemBlock_TopLevel_MemBlock_CounterModule MemBlock_TopLevel_MemBlock_CounterModule
(
...
(
// [BEGIN USER MAP FOR MemBlockModule]
// [END USER MAP FOR MemBlockModule]
	.BoardSignals_Clock (BoardSignals_Clock),
	.BoardSignals_Reset (BoardSignals_Reset),
	.BoardSignals_Running (BoardSignals_Running),
	.BoardSignals_Starting (BoardSignals_Starting),
	.BoardSignals_Started (BoardSignals_Started),
	.Common_Address (MemBlockModuleCommon_AddressMemBlockModule_Common_AddressHardLink),
	.Common_WriteValue (MemBlockModuleCommon_WriteValueMemBlockModule_Common_WriteValueHardLink),
	.Common_WE (MemBlockModuleCommon_WEMemBlockModule_Common_WEHardLink),
	.Common_RE (MemBlockModuleCommon_REMemBlockModule_Common_REHardLink),
	.Common_MemAccessMode (MemBlockModuleCommon_MemAccessModeMemBlockModule_Common_MemAccessModeHardLink),
	.DeviceAddress (MemBlockModuleDeviceAddressMemBlockModule_DeviceAddressHardLink),
	.ReadValue (MemBlockModuleReadValueMemBlockModule_ReadValueHardLink),
	.IsReady (MemBlockModuleIsReadyMemBlockModule_IsReadyHardLink),
	.IsActive (MemBlockModuleIsActiveMemBlockModule_IsActiveHardLink)
...
for (QuSoCModule_L108F13L121T14_idx = 0; QuSoCModule_L108F13L121T14_idx < 3; QuSoCModule_L108F13L121T14_idx = QuSoCModule_L108F13L121T14_idx + 1)
begin
...
assign QuSoCModule_L46F47T98_Source[0] = MemBlockModule_IsActive;
assign QuSoCModule_L46F47T98_Source[1] = CounterModule_IsActive;
assign QuSoCModule_L46F47T98_Source[2] = InstructionsRAM_IsActive;
...
assign CounterModule_DeviceAddress = MemBlock_generated_L17F104T114_Expr;
assign MemBlockModule_Common_Address = ModuleCommon_Address;
assign MemBlockModule_Common_WriteValue = ModuleCommon_WriteValue;
assign MemBlockModule_Common_WE = ModuleCommon_WE;
...
assign MemBlockModuleCommon_REMemBlockModule_Common_REHardLink = MemBlockModule_Common_RE;
assign MemBlockModuleCommon_MemAccessModeMemBlockModule_Common_MemAccessModeHardLink = MemBlockModule_Common_MemAccessMode;
assign MemBlockModuleDeviceAddressMemBlockModule_DeviceAddressHardLink = MemBlockModule_DeviceAddress;
assign MemBlockModule_ReadValue = MemBlockModuleReadValueMemBlockModule_ReadValueHardLink;
assign MemBlockModule_IsReady = MemBlockModuleIsReadyMemBlockModule_IsReadyHardLink;
assign MemBlockModule_IsActive = MemBlockModuleIsActiveMemBlockModule_IsActiveHardLink;
assign QuSoCModule_L127F40T73_Mux1 = InstructionsRAM_ReadValue;
assign QuSoCModule_L127F40T73_Mux2 = CounterModule_ReadValue;
assign QuSoCModule_L127F40T73_Mux3 = MemBlockModule_ReadValue;
...
assign QuSoCModule_L128F39T70_Mux3 = MemBlockModule_IsReady;
