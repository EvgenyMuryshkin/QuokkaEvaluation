...
// 
// System configuration name is MemBlock_TopLevel_MemBlock_UARTSim, clock frequency is 1Hz, Embedded
// FSM summary
// -- Packages
module MemBlock_TopLevel_MemBlock_UARTSim (
// [BEGIN USER PORTS]
// [END USER PORTS]
...
initial
begin
	$readmemh("MemBlock_TopLevel_MemBlock_UARTSim_State_UART.hex", State_UART);
end
