...
-- 
-- System configuration name is OverrideInputsComposition_TopLevel_OverrideInputsComposition_L1Override, clock frequency is 1Hz, Embedded
library ieee;
...
entity OverrideInputsComposition_TopLevel_OverrideInputsComposition_L1Override is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of OverrideInputsComposition_TopLevel_OverrideInputsComposition_L1Override is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
