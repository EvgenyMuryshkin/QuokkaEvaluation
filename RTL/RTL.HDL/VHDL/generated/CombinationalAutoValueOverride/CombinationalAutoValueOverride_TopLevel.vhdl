...
-- 
-- System configuration name is CombinationalAutoValueOverride_TopLevel, clock frequency is 1Hz, Top-level
library ieee;
...
entity CombinationalAutoValueOverride_TopLevel is
    port
    (
-- [BEGIN USER PORTS]
-- [END USER PORTS]
...
-- FSM summary
-- Packages
architecture rtl of CombinationalAutoValueOverride_TopLevel is
-- [BEGIN USER SIGNALS]
-- [END USER SIGNALS]
