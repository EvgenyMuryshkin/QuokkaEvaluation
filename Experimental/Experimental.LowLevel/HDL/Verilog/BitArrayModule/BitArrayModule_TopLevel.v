...
// [END USER PORTS]
	...
	input  [8: 1] BitArrayModuleValue,
	output [8: 1] BitArrayModuleDirect,
	output [4: 1] BitArrayModuleHigh,
	output [4: 1] BitArrayModuleLow,
	output [8: 1] BitArrayModuleReversed,
	output [4: 1] BitArrayModuleReversedHigh,
	output [4: 1] BitArrayModuleReversedLow,
	output [4: 1] BitArrayModulePicks
    );
...
wire  [2:1] BitArrayModule_TopLevel_BitArrayModule_BitArrayModule_L20F64T73_Index;
	assign BitArrayModule_TopLevel_BitArrayModuleValue = BitArrayModuleValue;
// Top-level entity connections
assign BitArrayModuleDirect = BitArrayModule_TopLevel_BitArrayModuleDirect;
assign BitArrayModuleHigh = BitArrayModule_TopLevel_BitArrayModuleHigh;
assign BitArrayModuleLow = BitArrayModule_TopLevel_BitArrayModuleLow;
assign BitArrayModuleReversed = BitArrayModule_TopLevel_BitArrayModuleReversed;
assign BitArrayModuleReversedHigh = BitArrayModule_TopLevel_BitArrayModuleReversedHigh;
assign BitArrayModuleReversedLow = BitArrayModule_TopLevel_BitArrayModuleReversedLow;
assign BitArrayModulePicks = BitArrayModule_TopLevel_BitArrayModulePicks;
