...
PartialData : out  unsigned(8 downto 1)
    );
end entity;
...
process(Ack, Bit, BoardSignals, CompositionModule_TopLevel_CompositionModule_Receiver_Data, CompositionModule_TopLevel_CompositionModule_Receiver_HasData, CompositionModule_TopLevel_CompositionModule_Receiver_PartialData, IsValid)
begin
	CompositionModule_TopLevel_CompositionModule_Receiver_IsValid <= IsValid;
	CompositionModule_TopLevel_CompositionModule_Receiver_Ack <= Ack;
	CompositionModule_TopLevel_CompositionModule_Receiver_Bit <= Bit;
HasData <= CompositionModule_TopLevel_CompositionModule_Receiver_HasData;
Data <= CompositionModule_TopLevel_CompositionModule_Receiver_Data;
PartialData <= CompositionModule_TopLevel_CompositionModule_Receiver_PartialData;
end process;
