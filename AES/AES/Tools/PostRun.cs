...
namespace AES
{
    ...
    public class PostRun : ILowLevelTransformationPostRun
    {
        ...
        public void Run()
        {
            _logStream.WriteLine(DirectoryLogging.Summary, $"AES translation completed");
            ...
            var hdlLocation = Path.Combine(Path.GetDirectoryName(_runtimeConfiguration.SourceLocation), "AES.HDL");
